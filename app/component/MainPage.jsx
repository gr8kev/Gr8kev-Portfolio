      ...
      <div className="cantsyat">
        <div className="mainn">
          <div className="djhdud">
            <div>
              <div className="nameofdev">OBI KELVIN</div>
              <div className="conff">
                <a href="mailto:ebukakels@gmail.com" className="email">
                  ebukakels@gmail.com
                </a>
              </div>
            </div>
          ...
          <div className="infoss">
            Hello and welcome to my digital space! I’m Obi Kelvin, a passionate
            problem solver who thrives on creating impactful software solutions.{" "}
            <br /> <br />
            ...
            the pinnacle of software engineering excellence. <br /> <br /> At
            the moment, I’m building something exciting — a software called{" "}
            <a href="https://penafortwinery.com/" className="email">
              PW (PenafortWinery)
            </a>
            . <br />
            <br />
            An online asset whose backend Structure is presently on Python...
            <br />
          ...
          <div className="projj">
            ...
            <div className="kfie">
              ...
              <div className="mt-3">
                <a href="https://github.com/gr8kev" className="eifj">
              ...
              <div className="mt-3">
                <a href="https://wa.link/y99dwt" className="eifj">
                  <div className="bugsss">
                    <div>
                      <WhatsAppIcon />
                    </div>
              ...
              <div className="ouuu">
                ...
                <div className="mt-3">
                  <div className="rights">
                    © MMXXV OBI KELVIN . | All Rights Reserved.
                  </div>
                </div>
                <div className="rights">
                  Source Code:{" "}
                  <a href=" https://github.com/gr8kev/gr8kev" className="email">
                    https://github.com/gr8kev/gr8kev
                  </a>
                </div>
              </div>
            </div>
